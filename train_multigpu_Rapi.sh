...
#pretrained (230214)
python3 -m torch.distributed.launch --nproc_per_node 8 --master_port 9527 train.py --workers 96 --device 0,1,2,3,4,5,6,7 --sync-bn --batch-size 96 --data data/hyp.Xray.Rapi_orig.yaml --img-size-train 1050 1680 --cfg cfg/training/yolov7.yaml --weights ''  --name Xray_Rapi_orig_multiGPU_rect --hyp data/hyp.scratch.p5.yaml